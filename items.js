const resources = [
    { name: "Стекло", amount: "192 (3 стака)", id: "Glass" },
    { name: "Книжная полка", amount: 26, id: "Bookshelf" },
    ...
    { name: "Яйцо призыва: Мул", amount: 1, id: "Mule_Spawn_Egg" },
    ...
    { name: "Слизь", amount: "Неизвестно", id: "Slimeball" },
];
